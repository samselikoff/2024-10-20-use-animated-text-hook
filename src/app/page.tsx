    ...
    <div className="relative m-8">
      <div className="mt-10 flex items-center justify-between gap-4">
        <div className="flex gap-2">
          <button
            className={`${isPlaying ? "bg-accent text-white hover:bg-accent-light" : "bg-gray-300 text-gray-500 hover:bg-gray-400/40"} inline-flex w-32 items-center justify-center gap-1 rounded-lg p-2 font-semibold hover:bg-accent-light`}
